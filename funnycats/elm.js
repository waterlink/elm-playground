...
Elm.FunnyCats = Elm.FunnyCats || {};
Elm.FunnyCats.make = function (_elm) {
   "use strict";
   _elm.FunnyCats = _elm.FunnyCats || {};
   if (_elm.FunnyCats.values)
   return _elm.FunnyCats.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "FunnyCats",
   $Basics = Elm.Basics.make(_elm),
   ...
   var modelStyle = $Html$Attributes.style(_L.fromArray([A2(_op["=>"],
   "margin-left",
   "200px")]));
...
Elm.Main.make = function (_elm) {
   ...
   $Basics = Elm.Basics.make(_elm),
   $Effects = Elm.Effects.make(_elm),
   $FunnyCats = Elm.FunnyCats.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm),
